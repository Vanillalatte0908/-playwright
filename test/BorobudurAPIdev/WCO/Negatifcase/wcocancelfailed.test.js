...
test('should retrieve access token and call account binding API', async ({ request, page }) => {
  ...
  const body = {
    "originalPartnerReferenceNo": "WCOV2test1743585935217055171",
    "additionalInfo": {
        "refNum": "WCOV2test1743585935217055171"
    }
};
  ...
  expect(bindResult.responseCode).toBe('4055701');
  expect(bindResult.responseMessage).toBe('Requested Operation Is Not Allowed');
