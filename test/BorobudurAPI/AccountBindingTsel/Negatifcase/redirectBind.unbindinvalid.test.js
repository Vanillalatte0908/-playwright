...
expect(accessToken).toBeTruthy();
  ...
  const method = 'POST';
  const path = '/bi/v1.0/registration-account-unbinding';
  ...
  const body = {
    partnerReferenceNo:"MM153archive000100129514",
    merchantId:"506300908492350",
    tokenId:"1063747",
    additionalInfo:{
        scopes:"DIRECT_DEBIT_TRANSACTION",
        payerReferenceNumber:"MM1538archive000100129514",
  ...
  expect(bindResult.responseCode).toBe('4040911');
  expect(bindResult.responseMessage).toBe('Invalid Customer');
  });